...
# -------------------------------------------------------------
# Академический построитель родословных (без загрузки файлов)
...
st.title("📚 Построитель академических родословных")
st.caption(
...
st.subheader("Выбор начальных научных руководителей")
...
manual = st.text_area("Или добавьте имена вручную (по одному на строку)", height=120)
